...
public class RecipeRegistry {
	...
	private static void registerFoodRecipes() {
		...
		for(BlockPamSapling sapling : FruitRegistry.getSaplings()) {
			GameRegistry.addShapelessRecipe(new ItemStack(sapling), new ItemStack(sapling.getFruitItem()),
		...
		if(config.enablesaltfromwaterbucketrecipe)
			addShapelessOreRecipe(ItemRegistry.saltItem, toolPot, listAllwater);
	...
	private static void registerOtherRecipes() {
		...
		// Ground Trap
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(BlockRegistry.groundtrap, 1), new Object[] {"XTX",
				"OCO", "XOX", 'X', "stickWood", 'O', "string", 'C', Blocks.CHEST, 'T', Blocks.TRAPDOOR}));
		// Water Trap
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(BlockRegistry.watertrap, 1), new Object[] {"XFX",
				"OCO", "XOX", 'X', "stickWood", 'O', "string", 'C', Blocks.CHEST, 'F', Items.FISHING_ROD}));
		// Baits
		CraftingManager.getInstance().getRecipeList()
				.add(new ShapelessOreRecipe(
						new ItemStack(ItemRegistry.grainbaitItem, ConfigHandler.grainbaitrecipeamount), "string",
						"listAllgrain", "listAllgrain", "listAllgrain"));
		CraftingManager.getInstance().getRecipeList()
				.add(new ShapelessOreRecipe(
						new ItemStack(ItemRegistry.veggiebaitItem, ConfigHandler.veggiebaitrecipeamount), "string",
						"listAllveggie", "listAllveggie", "listAllveggie"));
		CraftingManager.getInstance().getRecipeList()
				.add(new ShapelessOreRecipe(
						new ItemStack(ItemRegistry.fruitbaitItem, ConfigHandler.fruitbaitrecipeamount), "string",
						"listAllfruit", "listAllfruit", "listAllfruit"));
		CraftingManager.getInstance().getRecipeList()
				.add(new ShapelessOreRecipe(
						new ItemStack(ItemRegistry.fishtrapbaitItem, ConfigHandler.fishtrapbaitrecipeamount), "string",
