...
public class RecipeRegistry {
    ...
    private static void registerFoodRecipes() {
        ...
        addShapelessOreRecipe(ItemRegistry.chickennoodlesoupItem, toolPot, listAllchickenraw, cropCarrot, foodPasta, foodStock);
        addShapelessOreRecipe(ItemRegistry.chickenpotpieItem, toolBakeware, listAllchickenraw, cropPotato, cropCarrot, foodDough);
        ...
        addShapelessOreRecipe(ItemRegistry.vegetablesoupItem, toolPot, cropPotato, cropCarrot, listAllmushroom, foodStock);
        ...
        addShapelessOreRecipe(ItemRegistry.hashItem, toolSkillet, cropOnion, listAllbeefcooked, cropPotato, foodKetchup);
        ...
        addShapelessOreRecipe(ItemRegistry.veggiestirfryItem, toolSkillet, cropBellpepper, cropCarrot, cropRice, cropOnion, cropBean);
        addShapelessOreRecipe(ItemRegistry.veggiestirfryItem, toolSkillet, cropBellpepper, cropCarrot, cropRice, cropOnion, cropChilipepper);
        addShapelessOreRecipe(ItemRegistry.veggiestirfryItem, toolSkillet, cropBellpepper, cropCarrot, cropRice, cropOnion, listAllmushroom);
        addShapelessOreRecipe(ItemRegistry.grilledskewersItem, toolCuttingboard, cropBellpepper, cropOnion, cropCarrot, stickWood);
        ...
        addShapelessOreRecipe(ItemRegistry.creamedbroccolisoupItem, toolPot, cropBroccoli, cropCarrot, foodFlour, foodBlackpepper, foodStock);
        ...
        addShapelessOreRecipe(ItemRegistry.roastedrootveggiemedleyItem, toolBakeware, cropTurnip, cropCarrot, cropOnion, cropSpiceleaf);
        addShapelessOreRecipe(ItemRegistry.roastedrootveggiemedleyItem, toolBakeware, cropPumpkin, cropCarrot, cropOnion, cropSpiceleaf);
        addShapelessOreRecipe(ItemRegistry.roastedrootveggiemedleyItem, toolBakeware, cropPotato, cropCarrot, cropOnion, cropSpiceleaf);
        addShapelessOreRecipe(ItemRegistry.roastedrootveggiemedleyItem, toolBakeware, cropSweetpotato, cropCarrot, cropOnion, cropSpiceleaf);
        addShapelessOreRecipe(ItemRegistry.roastedrootveggiemedleyItem, toolBakeware, cropRadish, cropCarrot, cropOnion, cropSpiceleaf);
        addShapelessOreRecipe(ItemRegistry.roastedrootveggiemedleyItem, toolBakeware, cropParsnip, cropCarrot, cropOnion, cropSpiceleaf);
        ...
        addShapelessOreRecipe(ItemRegistry.summersquashwithradishItem, toolMixingbowl, cropRadish, cropZucchini, cropPumpkin, cropSpiceleaf, foodOliveoil);
        addShapelessOreRecipe(ItemRegistry.celeryandpeanutbutterItem, cropCelery, listAllnutbutter);
        addShapelessOreRecipe(ItemRegistry.chickencelerycasseroleItem, toolBakeware, cropCelery, listAllchickenraw, cropGarlic, cropCarrot, listAllmushroom);
        ...
        addShapelessOreRecipe(ItemRegistry.footlongItem, toolCuttingboard, bread, listAllbeefcooked, cropLettuce, cropTomato, foodMayo);
        addShapelessOreRecipe(ItemRegistry.footlongItem, toolCuttingboard, bread, listAllchickencooked, cropLettuce, cropTomato, foodMayo);
        addShapelessOreRecipe(ItemRegistry.footlongItem, toolCuttingboard, bread, listAllporkcooked, cropLettuce, cropTomato, foodMayo);
        ...
        addShapelessOreRecipe(ItemRegistry.shepardspieItem, toolBakeware, listAllmuttonraw, cropPotato, cropCarrot, foodDough, cropPeas);
        ...
        addShapelessOreRecipe(ItemRegistry.applejellysandwichItem, toolCuttingboard, listAllnutbutter, foodApplejelly, bread);
        addShapelessOreRecipe(ItemRegistry.blackberryjellysandwichItem, toolCuttingboard, listAllnutbutter, foodBlackberryjelly, bread);
        addShapelessOreRecipe(ItemRegistry.blueberryjellysandwichItem, toolCuttingboard, listAllnutbutter, foodBlueberryjelly, bread);
        addShapelessOreRecipe(ItemRegistry.cherryjellysandwichItem, toolCuttingboard, listAllnutbutter, foodCherryjelly, bread);
        addShapelessOreRecipe(ItemRegistry.cranberryjellysandwichItem, toolCuttingboard, listAllnutbutter, foodCranberryjelly, bread);
        addShapelessOreRecipe(ItemRegistry.kiwijellysandwichItem, toolCuttingboard, listAllnutbutter, foodKiwijelly, bread);
        addShapelessOreRecipe(ItemRegistry.lemonjellysandwichItem, toolCuttingboard, listAllnutbutter, foodLemonjelly, bread);
        addShapelessOreRecipe(ItemRegistry.limejellysandwichItem, toolCuttingboard, listAllnutbutter, foodLimejelly, bread);
        addShapelessOreRecipe(ItemRegistry.mangojellysandwichItem, toolCuttingboard, listAllnutbutter, foodMangojelly, bread);
        addShapelessOreRecipe(ItemRegistry.orangejellysandwichItem, toolCuttingboard, listAllnutbutter, foodOrangejelly, bread);
        addShapelessOreRecipe(ItemRegistry.papayajellysandwichItem, toolCuttingboard, listAllnutbutter, foodPapayajelly, bread);
        addShapelessOreRecipe(ItemRegistry.peachjellysandwichItem, toolCuttingboard, listAllnutbutter, foodPeachjelly, bread);
        addShapelessOreRecipe(ItemRegistry.pomegranatejellysandwichItem, toolCuttingboard, listAllnutbutter, foodPomegranatejelly, bread);
        addShapelessOreRecipe(ItemRegistry.raspberryjellysandwichItem, toolCuttingboard, listAllnutbutter, foodRaspberryjelly, bread);
        addShapelessOreRecipe(ItemRegistry.starfruitjellysandwichItem, toolCuttingboard, listAllnutbutter, foodStarfruitjelly, bread);
        addShapelessOreRecipe(ItemRegistry.strawberryjellysandwichItem, toolCuttingboard, listAllnutbutter, foodStrawberryjelly, bread);
        addShapelessOreRecipe(ItemRegistry.watermelonjellysandwichItem, toolCuttingboard, listAllnutbutter, foodWatermelonjelly, bread);
        ...
        addShapelessOreRecipe(ItemRegistry.lambbarleysoupItem, toolPot, foodStock, listAllmuttonraw, cropOnion, cropCarrot, cropBarley);
        ...
        addShapelessOreRecipe(ItemRegistry.pumpkinoatsconesItem, toolBakeware, foodFlour, cropOats, cropPumpkin, foodButter);
        ...
        addShapelessOreRecipe(ItemRegistry.leekbaconsoupItem, toolPot, cropLeek, listAllporkcooked, cropPotato, listAllheavycream);
        ...
        addShapelessOreRecipe(ItemRegistry.apricotjellysandwichItem, toolCuttingboard, listAllnutbutter, foodApricotjelly, bread);
        ...
        addShapelessOreRecipe(ItemRegistry.figjellysandwichItem, toolCuttingboard, listAllnutbutter, foodFigjelly, bread);
        ...
        addShapelessOreRecipe(ItemRegistry.grapefruitjellysandwichItem, toolCuttingboard, listAllnutbutter, foodGrapefruitjelly, bread);
        ...
        addShapelessOreRecipe(ItemRegistry.persimmonjellysandwichItem, toolCuttingboard, listAllnutbutter, foodPersimmonjelly, bread);
        ...
        addShapelessOreRecipe(ItemRegistry.fairybreadItem, toolBakeware, bread, foodButter, dyeRed, dyeGreen, dyeYellow);
        ...
        addShapelessOreRecipe(ItemRegistry.meatfeastpizzaItem, toolPot, foodPizza, foodPepperoni, foodPorksausage, listAllbeefcooked, listAllchickencooked);
        ...
        addShapelessOreRecipe(ItemRegistry.gooseberryjellysandwichItem, toolCuttingboard, listAllnutbutter, foodGooseberryjelly, bread);
        ...
        addShapelessOreRecipe(ItemRegistry.hamsweetpicklesandwichItem, toolCuttingboard, foodSweetpickle, bread, listAllporkcooked, foodMayo);
        ...
        addShapelessOreRecipe(ItemRegistry.ploughmanslunchItem, toolCuttingboard, bread, cropApple, foodCheese, foodSweetpickle, cropOnion, listAllporkcooked, foodBoiledegg);
        ...
        addShapelessOreRecipe(ItemRegistry.honeysandwichItem, toolCuttingboard, listAllnutbutter, ItemRegistry.honeyItem, bread);
        ...
        addShapelessOreRecipe(ItemRegistry.pearjellysandwichItem, toolCuttingboard, listAllnutbutter, foodPearjelly, bread);
        ...
        addShapelessOreRecipe(ItemRegistry.plumjellysandwichItem, toolCuttingboard, listAllnutbutter, foodPlumjelly, bread);
    ...
    private static void registerMarketRecipe() {
        ...
        addShapedOreRecipe(new ItemStack(BlockRegistry.pamShippingbin, 1), "XOX", "OEO", "XOX", 'X', "plankWood", 'O', Blocks.LOG, 'E', marketRecipeItem);
    }
    
    private static void registerWellRecipes() {
    	addShapedOreRecipe(new ItemStack(BlockRegistry.well, 1), "XOX", "XOX", "XOX", 'X', "ingotIron", 'O', Blocks.STONE);
    }
    ...
    private static void registerOtherRecipes() {
      ...
      //Ground Trap
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(BlockRegistry.groundtrap, 1), new Object[]
                {
                    "XTX", "OCO", "XOX",'X', "stickWood", 'O', "string", 'C', Blocks.CHEST, 'T', Blocks.TRAPDOOR
                }));
		//Water Trap
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(BlockRegistry.watertrap, 1), new Object[]
                {
					"XFX", "OCO", "XOX",'X', "stickWood", 'O', "string", 'C', Blocks.CHEST, 'F', Items.FISHING_ROD
                }));
		//Baits
		CraftingManager.getInstance().getRecipeList().add(new ShapelessOreRecipe(new ItemStack(ItemRegistry.grainbaitItem, ConfigHandler.grainbaitrecipeamount), "string", "listAllgrain", "listAllgrain", "listAllgrain"));
		CraftingManager.getInstance().getRecipeList().add(new ShapelessOreRecipe(new ItemStack(ItemRegistry.veggiebaitItem, ConfigHandler.veggiebaitrecipeamount), "string", "listAllveggie", "listAllveggie", "listAllveggie"));
		CraftingManager.getInstance().getRecipeList().add(new ShapelessOreRecipe(new ItemStack(ItemRegistry.fruitbaitItem, ConfigHandler.fruitbaitrecipeamount), "string", "listAllfruit", "listAllfruit", "listAllfruit"));
		CraftingManager.getInstance().getRecipeList().add(new ShapelessOreRecipe(new ItemStack(ItemRegistry.fishtrapbaitItem, ConfigHandler.fishtrapbaitrecipeamount), "string", "listAllfishraw", "listAllfishraw", "listAllfishraw"));
    }
