...
public class TileEntityShippingBin extends TileEntity implements IInventory {
    ...
    void takeCurrencyFromSlot(int price) {
        if (this.paySlot != null) {
            this.paySlot.setCount(this.paySlot.getCount() - price);
        }
        this.markDirty();
    }
